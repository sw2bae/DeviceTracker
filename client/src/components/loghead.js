...
function LogHead({ btnStatus, sortByNum }) {
    ...
    <button type="button" className="btn btn-link" id="locatoin1">{btnStatus.charmode1}</button>
                </th>
                <th scope="col">Location To
    <button type="button" className="btn btn-link" id="location2">{btnStatus.charmode2}</button>
                </th>
